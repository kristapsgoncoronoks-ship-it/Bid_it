...
def test_g3_2_registry_ships_five_networks_in_order():
    ...
    # registered TFC fifth, and again when WO-68 registered Moeve sixth).
    # The CURRENT exact six-parser list is asserted by
    # `test_g3_2_moeve_fuel_card_parser.py::
    # test_g3_2_registry_ships_six_networks_in_order`.
