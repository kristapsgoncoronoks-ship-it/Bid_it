...
def test_readme_scale_numbers_match_the_live_tree():
    ...
    # Recounted at WO-AG: 109 `__tablename__` declarations across `app/models`
    # (WO-AB counted 108; WO-AG added `vat_country_requirements`),
    ...
    assert readme_tables == 109, "table count claim moved — recount __tablename__ across app/models"
