...
- **Slice 5+ (next):** `extraction_fields` (per-field capture confidence — needs OCR/AI confidence wired first); `document_versions`; approvals; polymorphic attachments/comments/notifications.
