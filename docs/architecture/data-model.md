...
- **Slice 5+ (next):** `document_versions` (supersession over this registry); `extraction_fields` (per-field capture confidence — needs OCR/AI confidence wired first); approvals; polymorphic attachments/comments/notifications.
