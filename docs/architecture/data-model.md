...
- **Slice 5+ (next):** `document_versions` (supersession over the 5d registry — needs a slot/owner identity first); approvals (generalise the inline expense-approval flow); polymorphic attachments/comments/notifications.
