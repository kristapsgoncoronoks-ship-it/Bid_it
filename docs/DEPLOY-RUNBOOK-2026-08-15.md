...
| Check | Result |
|---|---|
| **CI (GitHub runners)** | **run #479: ALL 8 JOBS SUCCESS — including `deploy`**, 2026-08-26 at WO-L `23c9b46` on `main`. **AUTO-DEPLOY IS LIVE**: the IPv4 fix (`ssh -4`; #477's failure was the runners' missing outbound IPv6) connected, and the VPS's forced `deploy` command ran 2m45s to success — the first production deploy ever executed by CI. Prior: #477 7/8 (deploy unreachable, fixed); #476/#473/#471/#470/#469/#465 SUCCESS |
| Backend suite | **2799 passed, 11 skipped, 0 failed (42:31)** on 2026-08-26 at WO-L `23c9b46` — adds transport claim hygiene (§12 ignore, §11 supplier list, §13 decisions incl. partial rejection) on top of everything through WO-K. **Production deployed AT this commit by CI #479's deploy job** — the nine pending migrations (`f0a2b4c6d8e0` … `c6d8e0f2a4b6`) went live with it |
| `ruff check` / `ruff format --check` | clean |
| `mypy app` | clean, 370 files |
| Alembic | single head `c6d8e0f2a4b6` (claim hygiene) — **production is CURRENT** (CI #479 deployed `23c9b46`, migrations run by `vps-deploy.sh` on the box) |
| Browser suite | **377 e2e + 13 visual = 390 passed** on 2026-08-26 at WO-L `23c9b46`, no flakes |
| Prior certified runs | 2791 / 386 browser 2026-08-26 at WO-K `176bbfa` (+ CI #477 code-green); 2782 / 382 browser 2026-08-26 at WO-G2 `edc6c22` (+ CI #473 all-green); 2776 / 380 browser 2026-08-25 at WO-J `7423dca` (+ CI #471 all-green); 2766 / 376 browser 2026-08-25 at WO-I `5d121ee` (+ CI #470 all-green); 2761 / 372 browser 2026-08-25 at the WO-H tree; 2754 / 369 browser 2026-08-25 at `46d3167` (+ CI #465 all-green); 2748 / 366 browser 2026-08-24 at `31e0e0b`; 2745 / 363 browser 2026-08-24 at `3d0f3cb` (one vat-claims flake re-ran clean 45/45; the WO-E round caught a real Customer-card crash, fixed before certifying); 2737 passed 2026-08-23 at `df9642a`; 2729 passed 2026-08-23 at the deployed tree `ee37037`; 2720 at `60e1faf`; 2714 at `2c5e93a`; 2705 2026-08-20 at `d2ba5b0`; 2694 2026-08-16 at `56bcab7` (single environmental failure — tesseract reinstalled, OCR 2/2) |
