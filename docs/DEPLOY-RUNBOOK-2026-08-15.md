...
| Check | Result |
|---|---|
| **CI (GitHub runners)** | **run #477: all 7 code jobs SUCCESS**, 2026-08-26 at WO-K `176bbfa` on `main` (push-triggered — the first real merge-to-main run). The 8th job, `deploy`, ran for the first time (owner set DEPLOY_ENABLED + secrets) and failed on INFRASTRUCTURE, not code: `ssh: Network is unreachable` — GitHub runners have no outbound IPv6; fixed by forcing `-4` in the workflow (next main push retries). Prior: #476 SUCCESS at `4f14be9`; #473 SUCCESS at WO-G2 `edc6c22`; #471 SUCCESS at WO-J `7423dca`; #470/#469/#465 SUCCESS |
| Backend suite | **2791 passed, 11 skipped, 0 failed (41:24)** on 2026-08-26 at WO-K `176bbfa` — adds the AR legal trio (Art. 219 reference, statutory late interest, MT940) on top of everything through WO-G2. Production is eight additive migrations behind (`f0a2b4c6d8e0` … `a4b6c8d0e2f4`, `b5c7d9e1f3a5`, all proven on scratch Postgres 16 — full chain incl. the Art. 219 backfill + `alembic check` + RLS + parity suites) |
| `ruff check` / `ruff format --check` | clean |
| `mypy app` | clean, 369 files |
| Alembic | single head `b5c7d9e1f3a5` (AR legal trio) — production is at `e9f1a3b5c7d9`, eight additive migrations behind |
| Browser suite | **373 e2e + 13 visual = 386 passed** on 2026-08-26 at WO-K `176bbfa`, no flakes |
| Prior certified runs | 2782 / 382 browser 2026-08-26 at WO-G2 `edc6c22` (+ CI #473 all-green); 2776 / 380 browser 2026-08-25 at WO-J `7423dca` (+ CI #471 all-green); 2766 / 376 browser 2026-08-25 at WO-I `5d121ee` (+ CI #470 all-green); 2761 / 372 browser 2026-08-25 at the WO-H tree; 2754 / 369 browser 2026-08-25 at `46d3167` (+ CI #465 all-green); 2748 / 366 browser 2026-08-24 at `31e0e0b`; 2745 / 363 browser 2026-08-24 at `3d0f3cb` (one vat-claims flake re-ran clean 45/45; the WO-E round caught a real Customer-card crash, fixed before certifying); 2737 passed 2026-08-23 at `df9642a`; 2729 passed 2026-08-23 at the deployed tree `ee37037`; 2720 at `60e1faf`; 2714 at `2c5e93a`; 2705 2026-08-20 at `d2ba5b0`; 2694 2026-08-16 at `56bcab7` (single environmental failure — tesseract reinstalled, OCR 2/2) |
