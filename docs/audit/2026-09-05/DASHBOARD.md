...
- **BE-005 (0e41463)** — charge claim committed after `charge_mit` → crash = double charge / claim committed BEFORE the provider call / billing.py / patched-provider test / DONE.
