...
**Scale of the codebase (verified against this tree):** 68 database tables
(74 Alembic revisions, single head), 47 model modules, 82 service modules,
39 route modules, 45 SPA pages, 1255 collected backend tests, 8 CI jobs.
