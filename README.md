...
**Scale of the codebase (verified against this tree):** 75 database tables
(82 Alembic revisions, single head), 47 model modules, 83 service modules,
39 route modules, 45 SPA pages, 1709 collected backend tests, 8 CI jobs.
