...
**Scale of the codebase (verified against this tree):** 74 database tables
(81 Alembic revisions, single head), 47 model modules, 83 service modules,
39 route modules, 45 SPA pages, 1620 collected backend tests, 8 CI jobs.
