...
**Scale of the codebase (verified against this tree):** 71 database tables
(78 Alembic revisions, single head), 47 model modules, 83 service modules,
39 route modules, 45 SPA pages, 1394 collected backend tests, 8 CI jobs.
