...
**Scale of the codebase (verified against this tree):** 81 database tables
(85 Alembic revisions, single head), 47 model modules, 83 service modules,
39 route modules, 49 SPA pages, 1981 collected backend tests, 8 CI jobs.
