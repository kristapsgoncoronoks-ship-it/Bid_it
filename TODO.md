...
- [x] **WO-80** — `Completed` — transport UI slice 2: the admin/config workspace. Closes the
  ...
  `null` (not zero), and the single integer field is a line COUNT. 46 new Playwright specs
  (70→116 frontend e2e passing) across the new `e2e/vat-admin.spec.ts` and the claims spec;
